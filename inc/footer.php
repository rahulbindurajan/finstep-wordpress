...
<footer class="site-footer">
  <div class="container">
    <div class="footer-grid">
      ...
      <div>
        ...
        <ul class="footer-links">
          ...
          <li><a href="<?php echo $base; ?>/about.php#philosophy">Our Philosophy</a></li>
      ...
      <div>
        ...
        <ul class="footer-links">
          <li><a href="<?php echo $base; ?>/contact.php">Grievance Redressal</a></li>
        </ul>
    ...
    <div class="footer-bottom">
      <p class="footer-copy">&copy; <?php echo date('Y'); ?> FinSteps Wealth Management Pvt. Ltd. All rights reserved.</p>
      <p class="footer-disclaimer">Mutual fund investments are subject to market risks. Please read all scheme-related documents carefully before investing. Past performance is not indicative of future results.</p>
    </div>
  </div>
</footer>

<!-- WhatsApp Float -->
<a href="https://wa.me/918592933387?text=Hello%2C%20I%27m%20interested%20in%20learning%20more%20about%20FinSteps%20Wealth%20mutual%20funds." class="whatsapp-float" target="_blank" rel="noopener" aria-label="Chat on WhatsApp">
